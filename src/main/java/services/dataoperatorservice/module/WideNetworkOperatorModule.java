...
import commonobjects.WideNetworkOperator;

public class WideNetworkOperatorModule extends DataOperatorModule {
    ...
    protected void configure() {
        bind(DataOperator.class).to(WideNetworkOperator.class);
        super.configure();
    }
